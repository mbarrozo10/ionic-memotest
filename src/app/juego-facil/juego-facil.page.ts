...
@Component({
  selector: 'app-juego-facil',
  templateUrl: './juego-facil.page.html',
  styleUrls: ['./juego-facil.page.scss'],
})
export class JuegoFacilPage implements OnInit {
  cardsBien: any[] = [
    {
      nombre: "gato",
      img:"../../assets/animales/gato.png"
    }, 
    {
      nombre: "perro",
      img:"../../assets/animales/perro.png"
    }, {
      nombre: "carpincho",
      img:"../../assets/animales/carpincho.png"
    }];
    cards: any[] = [
      {
        id:1,
